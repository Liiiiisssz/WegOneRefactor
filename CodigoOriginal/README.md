...
<div style="display: flex; justify-content: space-between; gap: 10px;">
  ...
  <img loading="lazy" src="https://img.shields.io/badge/%20GITHUB-8A4FFF?style=for-the-badge&logo=" style="width: 131px;"/>
...
```bash
cd 'C:\caminho\para\seu\projeto' & 'C:\caminho\para\java.exe' '@C:\caminho\para\arquivo.argfile' 'br.com.senai.centroweg.wegone.TelaInicial'
...
<img loading="Demonstração funcionamento front" src="/assets/front-end.gif" width="100%"/>
